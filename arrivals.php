...
<body class=".animation-delay">
  ...
  <div class="hero_area">
    ...
    <header class="header_section">
      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        <a class="navbar-brand" href="index.php">
          <!-- <span id="waving-effect" style="color: brown;font-size: 50px;text-shadow: 0 5px black;">TAC</span><span id="waving-effect" style="color:goldenrod;font-size: 50px;text-shadow: 0 5px black;">HS</span> -->
      </a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form style="margin-right: 8px;" action="search.php" method="get" class="d-flex" role="search">
           ...
           <button style="background-color: #eb657b;" class="btn btn-outline-secondary" type="submit">Search</button>
          </form>
            <nav>
    ...
    <!-- end header section -->
  <!-- shop section -->
     <section style="background-color:rgba(128, 128, 128, 0.233) ;" class="shop container">
      <h2 class="section-title" id="wecan">New Arrivals</h2>
        <!-- content -->
         <div class="shop-content">
            <!-- box 1 -->
             <div style="background-color: #fff;" class="product-box">
              <div class="new">
                <span>
                  New
                </span>
              </div>
                <img src="Saved Pictures/sneakers/isneak.jpg." alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">White Stylish Sneakers</h2>
                <span class="price">₦35,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
              ...
              <div class="product-box">
                ...
                <img src="Saved Pictures/Polo shirts/lacoste pique polo.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Lacoste Polo</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/beanie/beanie6.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Light Blue Beanie</h2>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/belts/cowboy belt.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Texan Cowboy Belt</h2>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/caps/cap7.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">Newyorker Cap</h2>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/button shirt/bshirt13.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">CHECKERED SHIRT</h2>
              ...
              <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/FEMALE GOWN/IMG_6642.JPG" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">PINK LONG GOWN</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/glasses/sunglasses12.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">TROPICAL SUNGLASSES</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/hoodie/gray hoodie.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">SMART GREY HODDIE</h2>
                <span class="price">₦15,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/socks/socks15.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">ANIMATED SOCKS</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/shorts/shorts3.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">SNEAR SHORTS</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/jacket/furry.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">FURRY WINTER JACKET</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">BROWN LEATHER SHOE</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img  src="Saved Pictures/caps/cap12.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">NIKE FACE CAP</h2>
                <span class="price">₦8,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
             <div style="background-color: #fff;" class="product-box">
                ...
                <img  src="Saved Pictures/Boxers&Briefs/boxers3.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">HANES 5 in 1 BOXERS</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/FEMALE JEAN/IMG_6661.JPG" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">LADIES JEAN</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img style="height: 250px;" src="Saved Pictures/button shirt/bshirt9.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 400;font-size: small;" class="product-title">SLEEVELESS GREEN SHIRT</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures\hoodie\tan hoodie.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">TAN HOODIE</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img  src="Saved Pictures/Polo shirts/ralph lauren red polo.jpg" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">RALPH LAUREN RED POLO</h2>
             ...
             <div style="background-color: #fff;" class="product-box">
                ...
                <img src="Saved Pictures/FEMALE GOWN/IMG_6630.JPG" alt="" class="product-img">
                <i class="fa fa-heart heart-icon" onclick="toggleFavorite(this)"></i>
                <h2 style="font-weight: 300;" class="product-title">STYLISH GOWN</h2>
                <span class="price">₦28,000</span>
                <p style="font-family: poopins;font-weight: 200; font-size: 17px;text-align: center; color: white;background-color: blue;margin-left: 40px;margin-right: 40px;">Shipped from Abroad</p>
                <i class='bx bxs-shopping-bag add-cart'></i>
             </div>
