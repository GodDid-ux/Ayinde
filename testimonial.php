...
<body>
  ...
  <div class="hero_area">
    ...
    <header class="header_section">
      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div style="background-color:rgba(255, 235, 205, 0.644);" class="collapse navbar-collapse innerpage_navbar" id="navbarSupportedContent">
          <ul class="navbar-nav  ">
            <li class="nav-item ">
  ...
  <section class="client_section layout_padding">
    ...
    <div style="margin-left: 45px;margin-right: 45px;margin-top: 5px;">
      <h2 style=" text-align: center; color: #333;font-family: Arial, sans-serif;">Leave a Comment</h2>
      <form id="commentForm" style="width: 50%;margin: 0 auto;background-color: #f4f4f4;padding: 20px;border-radius: 5px;box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);" action="submit_comment.php" method="POST">
          <label style="  font-weight: bold; color: #333;" for="name">Name:</label><br>
          <input style="width: 100%;
          padding: 10px;
          margin: 10px 0;
          border: 1px solid #ccc;
          border-radius: 4px;
          box-sizing: border-box;" type="text" id="name" name="name" required><br><br>
          
          <label style="  font-weight: bold;color: #333;" for="email">Email:</label><br>
          <input style="width: 100%;
          padding: 10px;
          margin: 10px 0;
          border: 1px solid #ccc;
          border-radius: 4px;
          box-sizing: border-box;" type="email" id="email" name="email" required><br><br>
          
          <label style="  font-weight: bold;color: #333;" for="comment">Comment:</label><br>
          <textarea style="width: 100%;
          padding: 10px;
          margin: 10px 0;
          border: 1px solid #ccc;
          border-radius: 4px;
          box-sizing: border-box;" id="comment" name="comment" rows="4" required></textarea><br><br>
          
          <input class="commentbotton" type="submit" value="Submit">
      </form>
    </div>
  </section>
  <!-- end client section -->
        ...
        <div class="row">
          ...
          <form action="subscribe.php" method="POST">
            <h6>
              ...
              <h5 style="font-family: 'Times New Roman', Times, serif;font-size: 12px;">NEW TO TACHS?</h5>
